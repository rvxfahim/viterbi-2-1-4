// -------------------------------------------------------------------------
// decoder.sv -- GENERATED FILE, DO NOT EDIT
//
...
//
// Block:     7 message bits -> 7 trellis stages, 14 code bits
// Decision:  hard
...
module decoder(clk, reset, dat, out, ready);
  ...
  always @ (posedge clk ) begin
    ...
    if(!reset) begin
      ...
      // began with a stale counter of 8 and emitted nothing -- the design
